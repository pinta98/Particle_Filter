...
void cRayMarching::init(Particle_t* particles,
                        float* distMap,
                        Cloud_t *cloud,
                        Map_t *map,
                        int n_particles,
...
void cRayMarching::calculateRays(Particle_t* particles,
                                 int n_particles, float *rays)
{
    // copy to gpu
    cudaMemcpyAsync(
    ...
    cuda_ray_marching<<<numBlocks, blockSize, 0, stream>>>(d_particles,
                                                           d_distGrid,
                                                           d_raysAngle,
                                                           n_particles,
                                                           d_cloud,
